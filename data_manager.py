...
def load_cohorts() -> list[dict]:
    ...
    if not COHORTS_FILE.exists():
        ...
        default_cohorts = [
            {
                "id": "cohort-1",
                "name": "NELFT Mentoring Programme - Cohort 1 (March 2025)",
                "active": True,
                "start_date": "2025-03-01"
            },
            {
                "id": "cohort-2", 
                "name": "NELFT Mentoring Programme - Cohort 2 (June 2025)",
                "active": True,
                "start_date": "2025-06-01"
            },
            {
                "id": "cohort-3",
                "name": "NELFT Mentoring Programme - Cohort 3 (September 2025)",
                "active": True,
